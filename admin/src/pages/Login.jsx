        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative flex items-center">
              <input
                className="border border-zinc-200 focus:border-primary focus:ring-2 focus:ring-indigo-100 outline-none rounded-xl p-3 w-full text-sm text-gray-800 transition-all placeholder:text-gray-400 bg-gray-50/50 pr-10"
