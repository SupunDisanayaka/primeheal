...
router.get('/recent-appointments', verifyToken, requireRole(['admin', 'receptionist', 'accountant']), getAdminRecentAppointments);
...
router.patch('/appointments/:appointmentId/status', verifyToken, requireRole(['admin', 'receptionist', 'accountant']), updateAppointmentStatus);
